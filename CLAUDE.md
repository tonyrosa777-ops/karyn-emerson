# CLAUDE.md — Karyn Emerson Real Estate Project Rules
#
# VARIABLES FILLED (Task 1 of /prime — complete):
#   BUSINESS_NAME     = "Karyn Emerson Real Estate"
#   DOMAIN            = "karynemerson.com"  (working placeholder; domain purchase after demo — one find-and-replace swaps this across the entire codebase)
#   BUSINESS_TYPE     = "Licensed real estate agent (buyer + seller representation)"
#   LOCATION          = "Salem, NH"
#   LAUNCH_TARGET     = "TBD — ASAP after client purchase"
#   PRIMARY_AUDIENCE  = "Southern NH home sellers (age ~62) and MA→NH relocating buyers (age 30–45)"
#   CORE_OFFER        = "Buyer and seller representation in Southern NH"
#   KEY_GOAL          = "Generate inbound leads independently of Zillow and Jill & Co.'s platform"
#   BOOKING_ENGINE    = "Calendly (demo URL during build — real URL swapped pre-launch)"
...
Never embed third-party redirects that take users off the karynemerson.com domain.
...
Calendly (demo URL during build — real URL swapped pre-launch). Every extra click
costs conversions. Every domain redirect costs trust.

## SEO Rule
Every page must include: semantic HTML5 structure, unique title tag, meta
description, Open Graph tags, RealEstateAgent schema markup, crawlable text

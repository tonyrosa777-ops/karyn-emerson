...
#   Karyn Emerson Real Estate     → e.g. "The Enchanted Collective"
#   karynemerson.com            → e.g. "enchantedmadison.com"
#   Licensed real estate agent (buyer + seller representation)     → e.g. "luxury glamping and romantic experience property"
#   Salem, NH          → e.g. "Madison, Indiana"
#   TBD — ASAP after client purchase     → e.g. "June 2026"
#   Southern NH home sellers (age ~62) and MA→NH relocating buyers (age 30–45)  → e.g. "romantic couples aged 27–45 within 90 min drive"
#   Buyer and seller representation in Southern NH        → e.g. "glamping tents, cottage, day-use hot tub escapes, proposal packages"
#   Generate inbound leads independently of Zillow and Jill & Co.’s platform          → e.g. "drive direct bookings and own the romantic getaway category in southern Indiana"
#   Calendly (demo URL during build)    → e.g. "Lodgify (launch) / OwnerRez (scale)"
#   RealEstateAgent       → e.g. "LodgingBusiness" or "LocalBusiness" or "ProfessionalService"

---

You are the orchestrator for the **Karyn Emerson Real Estate** (karynemerson.com) website build.
...
| Variable | Source |
|----------|--------|
| Karyn Emerson Real Estate | initial-business-data.md Section 1 |
| karynemerson.com | initial-business-data.md Section 1 |
| Licensed real estate agent (buyer + seller representation) | initial-business-data.md Section 1 — one-phrase description |
| Salem, NH | initial-business-data.md Section 1 |
| TBD — ASAP after client purchase | initial-business-data.md Section 7 |
| Southern NH home sellers (age ~62) and MA→NH relocating buyers (age 30–45) | initial-business-data.md Section 3 — specific, not generic |
| Buyer and seller representation in Southern NH | initial-business-data.md Section 2 |
| Generate inbound leads independently of Zillow and Jill & Co.’s platform | initial-business-data.md Section 5 |
| Calendly (demo URL during build) | initial-business-data.md Section 5 — or "TBD — confirm before Phase 4" |
| RealEstateAgent | infer from business type — LocalBusiness / ProfessionalService / LodgingBusiness |
...
```bash
# Site
NEXT_PUBLIC_SITE_URL=https://karynemerson.com
...
19. Route structure — /service-areas/[city]:
    ...
    A. src/app/service-areas/page.tsx — index page
       ...
       - generateMetadata: title "Service Areas | Karyn Emerson Real Estate"
    ...
    C. src/app/service-areas/[city]/page.tsx — individual city page (SERVER component)
       ...
       - generateMetadata({ params }): unique title + description per city
         title: "[Service] in [City], [State] | Karyn Emerson Real Estate"
